...
const config: Config = {
  ...
  tagline: 'Empowering the next generation of AI-Native Roboticists',
  ...
  plugins: [
    './plugins/webpack-proxy-plugin.js', // Register the custom proxy plugin
  ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub',
              href: 'https://github.com/facebook/docusaurus', // Change to project repo later
            },
            {
              label: 'Discord',
